...
const getSupplierMasters = (state = initialState, action) => {
  console.log('action', action)
  switch (action.type) {
    case GET_SUPPLIER_MASTER_LIST_SUCCESS:
      return {
        ...state,
    ...
    case GET_SUPPLIER_MASTER_LIST_FALIURE:
      return {
        ...state,
...
export default getSupplierMasters
