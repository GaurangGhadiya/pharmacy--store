...
const getMenufacturerMaster = (state = initialState, action) => {
  switch (action.type) {
    case GET_MENUFACTURER_MASTER_LIST_SUCCESS:
      return {
        ...state,
    ...
    case GET_MENUFACTURER_MASTER_LIST_FALIURE:
      return {
        ...state,
...
export default getMenufacturerMaster
