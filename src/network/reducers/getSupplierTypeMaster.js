...
const getSupplierTypeMaster = (state = initialState, action) => {
  switch (action.type) {
    case GET_SUPPLIER_TYPE_MASTER_LIST_SUCCESS:
      return {
        ...state,
    ...
    case GET_SUPPLIER_TYPE_MASTER_LIST_FALIURE:
      return {
        ...state,
...
export default getSupplierTypeMaster
